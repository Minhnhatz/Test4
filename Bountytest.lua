...
for i = 1, 1 do
    wait(0.1)
    if game:GetService("CoreGui"):FindFirstChild("AlchemyHubUIB") then
...
AlchemyHubUIToggle.Name = "AlchemyHubUIToggle"
...
ServerHopShadow_2.Parent = AlchemyHubUIToggle
...
Logo.Image = "rbxassetid://15780186180"
...
function wTest() 
    local data = {
        ...
        ["embeds"] = {
            {
                ["title"] = "Alchemy Hub V2 | Auto Bounty Webhook",
                ["color"] = 0x00ff95,
                ["fields"] = {
                    {
                        ["name"] = "Starting...",
                        ["value"] = "Thank you for using Alchemy Hub Script.",
                        ["inline"] = false,
                    },
                },
                ["image"] = {
                ...
                ["footer"] = {
                    ["text"] = "Alchemy Hub - discord.gg/dUdzZskBCC",
                },

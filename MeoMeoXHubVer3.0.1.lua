local Update = https://raw.githubusercontent.com/lobox920/Notification-Library/Main/Library.lua
...
Main:Label("Script By @ghost")
Main:Button("Copy Discord Link",function()
setclipboard("https://discord.gg/GcamKnR7qw") 
end)

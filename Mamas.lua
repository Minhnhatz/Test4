...
local Window = Fluent:CreateWindow({
    Title = "Alchemy Hub - Next Gen",
    SubTitle = "discord.gg/alchemyhub",
    TabWidth = 160,
...
local Tabs = {
	...
	Misc = Window:AddTab({ Title = "Misc", Icon = "align-end-horizontal" }),
...
----------------------------------------------------------------------------------------------------------------------------------------------
    Tabs.Main:AddButton({
       Title = "Discord Alchemy Hub",
       Description = "Join Discord For Info",
       Callback = function()
           discordlink()
    end
})
